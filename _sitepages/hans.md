...
author: 'JKD WNG'
layout: page
guid: 'https://jkdwednite.com/newsite/?page_id=372'
...
siteorigin_premium_meta:
    - 'a:3:{s:12:"logo_booster";a:3:{s:4:"base";s:0:"";s:6:"sticky";s:0:"";s:24:"so_field_container_state";s:6:"closed";}s:12:"_sow_form_id";s:32:"185616466964b967c4e9645593129943";s:19:"_sow_form_timestamp";s:0:"";}'
ppma_authors_name:
    - 'JKD WNG'
footnotes:
    - ''
...
After several sessions with Tim Tackett I was privileged to become a member of the Wednesday Night Group and he allowed me officially to use the name Jeet Kune Do for my school in Belgium. Through Tim I had the opportunity to meet Bob and his wife Sharon again in 2008 at his home in California. Ever since that day I teach JKD to my students and all members are motivated to train on the highly sophisticated techniques, after all it is like Tim says, JKD is simple but difficult to learn. Members often spend hours of training on just one single technique, satisfaction is even greater when they can master it and feel the effectiveness of it.

For myself Jeet Kune Do is a path to self knowledge, and most important of JKD are the hard core basics from where self expression starts already. The path to self knowledge is extremely important for development of drills and exercises by all JKD followers and instructors. For all that the expression, hack away the unessential and add what is essentially your own should be constantly in our minds. Since a few years I’m a Full Instructor under the Wednesday Night Group for which I’m very grateful, not only for the recognition but also and in the first place for the brotherhood and the friendship that we have when we meet again and train together. It was Tim and Bob who laid the foundation for the Wednesday Night Group and build on it until today. [Official Instructors](https://jkdwednite.com/official/) as well as [Affiliated Instructors](https://jkdwednite.com/affiliated/) and students of the group support each other like it was a real family business, in that case the WNG is unique in his kind and all that in my opinion is thanks to Tim, our main mentor in original JKD and for some of us even something like a second father.
