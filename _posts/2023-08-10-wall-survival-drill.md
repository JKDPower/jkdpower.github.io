...
**2.** Clinching on the 1/2 beat. You should clinch on either the 1/2, 1 <sup>1/2</sup>, 2 <sup>1/2</sup> or 3 <sup>1/2</sup> beat motion. No more than 4 punches should be thrown at you before clinching. Clinching should be done on 3 levels: 1. Head 2. Body 3. Legs (drill teaches timing on when to engage).
...
Remember to start slow and then pick up the pace. Mix 1 <sup>1/2</sup> punch combos, break in and out and step in at three different angles: 1. Diagonal left 2. Straight in 3. Diagonal right.
...
***See the complete drills in action at [erikpaulson.com](https://erikpaulson.com/).***